  ...
  return (
    <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full'>
        <div className='max_padd_container relative top-32 xs:top-52'>
            ...
            <p className='text-gray-50 regular-16 mt-6 max-w-[33rem]'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quaerat ullam assumenda necessitatibus autem ab libero magni fugit. Repellat possimus, totam reiciendis nostrum exercitationem, facilis ipsum recusandae dignissimos perferendis, natus illo. Similique, in corrupti.</p>
